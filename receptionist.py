    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            instructions=[
                ...
                "IMPORTANTE: Se receber um nome do sistema, confirme sempre: 'Posso confirmar que está a falar [Nome]?'",
                "Se o cliente não confirmar ou corrigir o nome, use o nome correto fornecido pelo cliente.",
                "Se não tiver nome nenhum, pergunte: 'Posso saber o seu nome para fazer o registo?'",
